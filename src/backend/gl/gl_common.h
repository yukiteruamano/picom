...
bool gl_image_op(backend_t *base, enum image_operations op, image_handle image_data,
...
image_handle gl_clone(backend_t *base, image_handle image_data, const region_t *reg_visible);
